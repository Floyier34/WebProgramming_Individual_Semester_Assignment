...
$per_page = 9;
$total = count_devices_by_category($conn, $id);
$total_pages = $total > 0 ? (int) ceil($total / $per_page) : 1;
if ($page > $total_pages) {
	$page = $total_pages;
}
$offset = ($page - 1) * $per_page;
$devices = get_devices_by_category_paginated($conn, $id, $per_page, $offset, $sort);
...
<body>
	<div class="container">
		...
		<!-- //TODO: Use main-content-wrapper for consistent sidebar layout -->
